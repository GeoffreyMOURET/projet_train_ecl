"""
Django settings for projet_perso project.
...
SECRET_KEY = 'aacgdjlormupdr3_c3hlw$o=6-t(99txs%eo%8sbtpvrn4tbv3'
...
ROOT_URLCONF = 'projet_perso.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
			# This line enables the utilisation of the folder "templates" to stock HTML and Cie files
...
WSGI_APPLICATION = 'projet_perso.wsgi.application'
